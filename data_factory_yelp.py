...
def get_data(item, hist_user, evalue_user, feature):
    ...
    test_matrix = item_select_pool[:, np.random.choice([i for i in range(hist_user, item_select_pool.shape[1])], evalue_user, replace=False)]
